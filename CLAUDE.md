...
```bash
npm test                  # 276 tests: normlogica, paspoort, ontsmetting, fasebalans
```
...
**Live:** app `v2026-09-12-A` + security-release + landing + blog (2 artikelen). Testsuite **276 tests** (`npm test`). Alles t/m `v2026-09-03-A` veldbevestigd door Martin.
...
- Lever bij elke release: gewijzigde bestanden, testresultaat (alle tests groen, nu 276), buildresultaat, en een korte samenvatting van wat de gebruiker merkt. Meld gedragswijzigingen expliciet, ook kleine.
